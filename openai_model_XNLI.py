...
async def main(input_file: str, output_file: str, model_name: str):
    ...
    for _, row in df.iterrows():
        ...
        messages = [
            {"role": "system", "content": "Please identify whether the premise entails or contradicts the hypothesis in the following premise and hypothesis. The answer should be exact entailment, contradiction , or  neutral. "},
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_name", type=str, default="gpt-3.5-turbo", help="Name of the GPT model to use (default: gpt-3.5-turbo)")
