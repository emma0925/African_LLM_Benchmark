...
PYTHON_SCRIPT_PATH="/Users/emma.zhuang/dev/my_own_code/Masakhane/openai_model8.py"

# Path to your Python script.
# Make sure this path points to where openai_model5.py is located.
FOLDER_PATH="/Users/emma.zhuang/dev/my_own_code/Masakhane/africanli"
